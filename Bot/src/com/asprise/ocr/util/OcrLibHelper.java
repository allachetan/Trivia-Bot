...
import com.asprise.ocr.Ocr.PageType;
import com.asprise.ocr.Ocr.PropertyBuilder;
...
public class OcrLibHelper
{
    ...
    try
    {
      if (StringUtils.isEmpty(System.getProperty("ASPRISE_OCR_LIB_FILE")))
      {
        fileLib = Utils.extractResourceToFolder(OcrLibHelper.class.getClassLoader(), 
          Utils.firstNotEmpty(new String[] {System.getProperty("ASPRISE_OCR_LIB_PATH"), libFileName }), 
          Utils.getTempFolderWritable(), "true".equalsIgnoreCase(System.getProperty("ASPRISE_OCR_FORCE_WRITE")));
    ...
    throws IOException
  {
    ...
    String s = ocr.recognize(getSampleImage(), "all", "pdf", new Object[] {new Ocr.PropertyBuilder()
