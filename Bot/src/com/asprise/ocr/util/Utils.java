...
public class Utils
{
  ...
  public static String flagToString(long value, Object... flagValueAndNames)
  {
    ...
    {
      if ((value & ((Long)flagValueAndNames[i]).longValue()) != 0L)
      {
        if (sb.length() > 0) {
          sb.append(" | ");
        }
  ...
  public static String getEnvInfo(boolean withClassPath)
  {
    ...
    sb.append("JVM: ").append(firstNotNull(new Object[] { System.getProperty("java.runtime.version"), System.getProperty("java.version") })).append(" ").append(is64Bit() ? "64bit" : "32bit").append(" by ").append(System.getProperty("java.vendor")).append("\n");
    if (withClassPath) {
  ...
  public static File getTempFolderWritable()
  {
    ...
    File[] dirs = { new File(System.getProperty("java.io.tmpdir")), new File(System.getProperty("user.dir")), new File(isWindows() ? ((System.getProperty("java.io.tmpdir") != null) && (System.getProperty("java.io.tmpdir").length() > 0) ? System.getProperty("java.io.tmpdir").substring(0, 1) : "C") + ":\\" : "/") };
    for (File dir : dirs) {
  ...
  public static void unzipToFolder(File zipFile, File outputFolder)
    throws IOException
  {
    outputFolder.mkdirs();
  ...
  public static File extractResourceToFolder(ClassLoader classLoader, String resourcePath, File targetFolder, boolean forceWrite)
    throws IOException
  {
  ...
  public static boolean openInFileExplorer(String path)
  {
    if (isWindows()) {
      try
      {
        Process p = new ProcessBuilder(new String[] { "explorer.exe", path }).start();
        return true;
      }
      catch (IOException e)
      {
  ...
  public static void saveToFile(URL url, File target)
    throws IOException
  {
